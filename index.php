        ...
        <div class="header">
            ...
            <div class="header-links">
                <div class="header-links-clickable">
                    <a href="login.php" class="link">Homepage</a>
                    <a href="login.php" class="link">Parking List</a>
                    <button class="btn btn-primary">My Parking</button>
                </div>
                <div>
                    <svg id="light-theme-toggle" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <svg id="dark-theme-toggle" class="hide" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
