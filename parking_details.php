...
<body>
    ...
    <div class="popup dropshadow hide" id="popup-youre-awesome">
        ...
        <h2 class="popup-title gradient-text" style="text-align: center; width: 100%;">🎊You're awesome!🎊</h2>
            <label style="text-align: center;">Your feedback is very important to us, and it helps us to make the ParKing app better for everyone.
    ...
    <div class="popup dropshadow hide" id="popup-arrived">
        ...
        <div class="user-account-settings-inputs max-input-width">
            <label style="text-align: center;"><b>One more thing.</b> Can you please roughly count the number of available parking spots around you?</label>
            ...
            <p class="details-feedback">Your feedback will help other users to find parking more easily. Thanks again!</p>
        </div>
    </div>
    <!-- Reserve popup -->
    ...
    <div class="popup dropshadow hide" id="popup-write-review">
        ...
        <div class="user-account-settings-inputs max-input-width">
            <div class="input-stack">
                ...
                <textarea name="additional-info" id="additional-info" cols="30" rows="10" class="input input-textarea" placeholder="Your review.."></textarea>
            </div>
            <div class="popup-review-stars">
                <div class="review-stars" id="review-stars-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="review-star hide">
                        <path fill="rgb(var(--star-yellow))" d="m12 17.3l-3.7 2.825q-.275.225-.6.213t-.575-.188q-.25-.175-.387-.475t-.013-.65L8.15 14.4l-3.625-2.575q-.3-.2-.375-.525t.025-.6q.1-.275.35-.488t.6-.212H9.6l1.45-4.8q.125-.35.388-.538T12 4.475q.3 0 .563.188t.387.537L14.4 10h4.475q.35 0 .6.213t.35.487q.1.275.025.6t-.375.525L15.85 14.4l1.425 4.625q.125.35-.012.65t-.388.475q-.25.175-.575.188t-.6-.213L12 17.3Z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="review-star">
                        <path fill="rgb(var(--star-yellow))" d="M9.6 16.65L12 14.8l2.4 1.85l-.9-3.05l2.25-1.6h-2.8L12 8.9l-.95 3.1h-2.8l2.25 1.6l-.9 3.05Zm2.4.65l-3.7 2.825q-.275.225-.6.213t-.575-.188q-.25-.175-.387-.475t-.013-.65L8.15 14.4l-3.625-2.575q-.3-.2-.375-.525t.025-.6q.1-.275.35-.488t.6-.212H9.6l1.45-4.8q.125-.35.388-.538T12 4.475q.3 0 .563.188t.387.537L14.4 10h4.475q.35 0 .6.213t.35.487q.1.275.025.6t-.375.525L15.85 14.4l1.425 4.625q.125.35-.012.65t-.388.475q-.25.175-.575.188t-.6-.213L12 17.3Zm0-4.525Z" />
                    </svg>
                </div>
    ...
    <div id="main-body" class="parking-details-body">
        <div class="parking-details-container">
            <div class="details-title">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="favorite-star hide">
                    <path fill="rgb(var(--star-yellow))" d="m12 17.3l-3.7 2.825q-.275.225-.6.213t-.575-.188q-.25-.175-.387-.475t-.013-.65L8.15 14.4l-3.625-2.575q-.3-.2-.375-.525t.025-.6q.1-.275.35-.488t.6-.212H9.6l1.45-4.8q.125-.35.388-.538T12 4.475q.3 0 .563.188t.387.537L14.4 10h4.475q.35 0 .6.213t.35.487q.1.275.025.6t-.375.525L15.85 14.4l1.425 4.625q.125.35-.012.65t-.388.475q-.25.175-.575.188t-.6-.213L12 17.3Z" />
                </svg>
                <h2>Biķernieku iela, bld. 79. Rīga</h2>
            </div>
            ...
            <div class="details-left">
                <div class="details-info">
                    ...
                    <div class="details-info-content">
                        <p class="details-info-text"><b>Spots available:</b> 24</p>
                        <p class="details-info-text"><b>Price:</b> 0.50€/h</p>
                        <p class="details-info-text"><b>Working hours:</b> 24/7</p>
                        <p class="details-info-text"><b>Owned by:</b> Rīgas Satiksme</p>
                    </div>
                </div>
                <div class="details-info">
                    <h3><b>Reviews</b></h3>
                    <div class="details-info-content details-reviews-list">
                        <div class="details-info-text">
                            ...
                            <p><b>5.0</b></p>
                            <p>This parking spot is amazing! It's located in a great spot, right in the heart of downtown. The price is also very reasonable. The spot is well-maintained and clean...</p>
                        </div>
                        <div class="details-info-text">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="review-star">
                                <path fill="rgb(var(--star-yellow))" d="m12 17.3l-3.7 2.825q-.275.225-.6.213t-.575-.188q-.25-.175-.387-.475t-.013-.65L8.15 14.4l-3.625-2.575q-.3-.2-.375-.525t.025-.6q.1-.275.35-.488t.6-.212H9.6l1.45-4.8q.125-.35.388-.538T12 4.475q.3 0 .563.188t.387.537L14.4 10h4.475q.35 0 .6.213t.35.487q.1.275.025.6t-.375.525L15.85 14.4l1.425 4.625q.125.35-.012.65t-.388.475q-.25.175-.575.188t-.6-.213L12 17.3Z" />
                            ...
                            <p><b>2.5</b></p>
                            <p>This parking spot is good, but not great. It's a bit pricey, and it can be difficult to find a spot, especially on weekends. However, the spot is well-lit and safe, and it's in a...</p>
                        </div>
                        <div class="details-info-text">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="review-star">
                                <path fill="rgb(var(--star-yellow))" d="m12 17.3l-3.7 2.825q-.275.225-.6.213t-.575-.188q-.25-.175-.387-.475t-.013-.65L8.15 14.4l-3.625-2.575q-.3-.2-.375-.525t.025-.6q.1-.275.35-.488t.6-.212H9.6l1.45-4.8q.125-.35.388-.538T12 4.475q.3 0 .563.188t.387.537L14.4 10h4.475q.35 0 .6.213t.35.487q.1.275.025.6t-.375.525L15.85 14.4l1.425 4.625q.125.35-.012.65t-.388.475q-.25.175-.575.188t-.6-.213L12 17.3Z" />
                ...
                <div class="details-buttons-write">
                    ...
                    <button class="btn btn-secondary" onclick="openPopup('popup-write-report')">Report a problem</button>
                </div>
            </div>
            <div class="details-right">
                <div class="mapouter map-details">
                    <iframe class="gmap_canvas map-details" width="400" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Slokas%20iela%2028&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                </div>
            </div>
        </div>
    </div>
