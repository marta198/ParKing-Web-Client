...
<body>
    ...
    while ($row = $getSingleParkingData->fetch()) {
        ?> 
            ...
            <div class="details-left">
                <div class="details-info">
                    ...
                    <div class="details-info-content">
                        <p class="details-info-text"><b>Spots available:</b><?php echo ($row["max_spots"] - $row["spots_taken"]); ?></p>
                        <p class="details-info-text"><b>Price:</b> <?php echo $row["price"] > 0 ? (sprintf("%.2f", $row["price"]) . "€/h") : "Free"; ?></p>
                        <p class="details-info-text"><b>Working hours:</b> 24/7</p>
                        <p class="details-info-text"><b>Owned by:</b><?php echo $row["company_name"]; ?></p>
                    </div>
                </div>
                <div class="details-info">
                    <h3><b>Reviews</b></h3>
                    <div class="details-info-content details-reviews-list">
                        <div class="details-info-text">
                            ...
                            <p><b>5.0</b></p>
                            <p>This parking spot is amazing! It's located in a great spot, right in the heart of
                                downtown. The price is also very reasonable. The spot is well-maintained and clean...
                            </p>
                        </div>
                        <div class="details-info-text">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                            ...
                            <p><b>2.5</b></p>
                            <p>This parking spot is good, but not great. It's a bit pricey, and it can be difficult to
                                find a spot, especially on weekends. However, the spot is well-lit and safe, and it's in
                                a...</p>
                        </div>
                        <div class="details-info-text">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
