...
<body>
    ...
    <div class="login-container">
        ...
        <form action="src/php/login.php" method="post" class="login-form">
            <div class="login-body">
                <div class="login-input-container">
                    <label for="username" class="login-label">Email</label>
                    <input type="text" name="username" id="username" placeholder="example@email.com" required class="input">
                </div>
                <div class="login-input-container">
                ...
                <div>
                    <input type="submit" value="Login" class="btn btn-primary" onclick="window.location.href='user_account.php'">
                </div>
            </div>
